...
* Set up an FTP password capture session using Metasploit. Log into this session from Windows Command Prompt with `ftp 192.168.1.2`
...
KoreLogic throws a yearly contest held at DefCon called [Crack Me If You Can](http://contest-2011.korelogic.com/). Your VM has the contest from 2011. Using John the Ripper and HashCat, try to crack as many passwords as you can.
