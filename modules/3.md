...
You can use `man nmap` or `nmap --help` to read about the `nmap` options, or [click here for an nmap cheat sheet](https://github.com/The-Art-of-Hacking/h4cker/blob/master/cheat-sheets/networking/nmap.md).
