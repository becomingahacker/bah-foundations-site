...
* [Course Materials](https://storage.googleapis.com/bah-public/presentations/passive-recon.pdf)
...
Using [osintframework.com](https://osintframework.com), navigate to `Domain Name` -> `Whois Records`. Use one of these tools to investigate the WHOIS records for `secretcorp.org`. Did you find anything interesting?
